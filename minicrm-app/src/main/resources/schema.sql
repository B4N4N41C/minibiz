...
CREATE TABLE IF NOT EXISTS chat_room (
    ...
    PRIMARY KEY (id),
    CONSTRAINT type_chat_check CHECK (
        (
            type_chat = ANY (ARRAY ['USER_CHAT', 'TASK_CHAT', 'GROUP_CHAT'])
        )
    )
);
...
create table IF NOT EXISTS note (
    id bigint generated always as identity constraint note_pk primary key,
    message text not null,
    task_id bigint not null constraint note_task_id_fk references task,
    date timestamp
);