...
import ru.miniprog.minicrmapp.users.internal.model.Token;
...
public class TokenCookieSessionAuthenticationStrategy implements SessionAuthenticationStrategy {
    ...
    public void onAuthentication(Authentication authentication, HttpServletRequest request,
        ...
        if (authentication instanceof UsernamePasswordAuthenticationToken) {
            ...
            UserCrm ff =  (UserCrm) authentication.getPrincipal();
            response.addCookie(new Cookie("Username", ff.getUsername()));
        }
    }
